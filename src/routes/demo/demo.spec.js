...
//       request.get('/demo/foo-is-required').expect(400, 'foo is required.'))
//   })
...
//       request.get('/demo/foo-must-be-numeric').expect(400, 'foo is required.'))
//   })
...
//       request.get('/demo/error').expect(500, 'App Error (this is intentional)!'))
//   })

//   describe('GET /demo/error-without-message', () => {
//     it('should result in 500 app error response', () =>
//       request.get('/demo/error-without-message').expect(500, ''))
//   })
// })
